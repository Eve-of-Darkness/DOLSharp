                            ...
                            if (GameServer.ServerRules.IsAllowedToAttack(Caster, player, true))
                            {
                                ...
                                if (SelectiveBlindness != null)
                                {
                                    ...
                                    if (EffectOwner == player)
                                    {
                                        if (Caster is GamePlayer)
                                        {
                                            ((GamePlayer)Caster).Out.SendMessage(string.Format("{0} is invisible to you!", player.GetName(0, true)), eChatType.CT_Missed, eChatLoc.CL_SystemWindow);
                                        }
                                    }
                                    else
                                    {
                            ...
                            if (Spell.Range > 0)
                            {
                                ...
                                if (SelectiveBlindness != null)
                                {
                                    ...
                                    if (EffectOwner == target)
                                    {
                                        if (Caster is GamePlayer)
                                        {
                                            ((GamePlayer)Caster).Out.SendMessage(string.Format("{0} is invisible to you!", target.GetName(0, true)), eChatType.CT_Missed, eChatLoc.CL_SystemWindow);
                                        }
                                    }
...
//          }
        ...
        public virtual void SendDamageMessages(AttackData ad)
        {
            ...
            else if (Caster is GameNPC)
            {
                MessageToCaster(
                    string.Format(
                    "Your " + Caster.Name + " hits {0} for {1}{2} damage!",
